...
import { OpcodeEngine, ScriptState } from "./OpcodeEngine";
...
export default function ScriptLab() {
    ...
    return (
        <div className="flex flex-col h-full space-y-6">
            ...
            {/* Title Section (Optional inside dashboard, but good for context) */}
            <div>
                <h2 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">
                    Script Lab ⚗️
                </h2>
                <p className="mt-1 text-slate-400 text-xs">Bitcoins Programmable Logic Debugger.</p>
            </div>
