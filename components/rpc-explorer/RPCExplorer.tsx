...
const COMMAND_GROUPS: { category: string; commands: CommandDef[] }[] = [
    {
        category: "Blockchain",
        commands: [
            { cmd: "getblockchaininfo", desc: "Full chain state summary" },
            { cmd: "getblockcount", desc: "Current block height" },
            { cmd: "getbestblockhash", desc: "Tip block hash" },
            { cmd: "getdifficulty", desc: "Current mining difficulty" },
            { cmd: "getchaintips", desc: "All known chain branches" },
            { cmd: "getchaintxstats", desc: "TX throughput stats" },
            { cmd: "getblockstats", desc: "Stats for a block height", template: "getblockstats <height>" },
            { cmd: "getblockhash", desc: "Hash at given height", template: "getblockhash <height>" },
            { cmd: "getblock", desc: "Block data by hash", template: "getblock <hash> 1" },
        ]
    },
    {
        category: "Network",
    ...
    },
    {
        ...
        commands: [
            ...
            { cmd: "getmempoolentry", desc: "Single TX mempool data", template: "getmempoolentry <txid>" },
        ]
    },
    {
        category: "Mining",
    ...
    },
    {
        ...
        commands: [
            { cmd: "getrawtransaction", desc: "Raw TX data", template: "getrawtransaction <txid> true" },
            { cmd: "decoderawtransaction", desc: "Decode raw TX hex", template: "decoderawtransaction <hex>" },
    ...
    },
    {
        ...
        commands: [
            ...
            { cmd: "getmemoryinfo", desc: "Node RAM usage" },
